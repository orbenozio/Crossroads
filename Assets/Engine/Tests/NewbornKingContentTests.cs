...
{
    // ולידציה של תוכן NewbornKing האמיתי (M9 על דאטה אמיתית, לא בדיקת-יחידה סינתטית).
    // טוען מהדיסק את story.json + resources.asset ומריץ דרך אותו StoryValidator שרץ בזמן-טעינה.
    public sealed class NewbornKingContentTests
    {
        private const string StoryPath = "Assets/Games/NewbornKing/Content/story.json";
        private const string ResPath = "Assets/Games/NewbornKing/Content/resources.asset";
        ...
        public void NewbornKing_Story_Validates_NoErrors()
        {
            ...
            Assert.IsNotNull(resources, "NewbornKing resources.asset missing at " + ResPath + " (run setup_games_content)");
